...
// Bundles @two80/sdk into one self-contained ESM file. @280/contracts is a private
// workspace package, so its identity module must be inlined or an app that installs
// @two80/sdk fails on its `workspace:*` spec. The SDK has no runtime dependencies of
